...
class Calculator extends React.Component {
  ...
  render() {
    return (
      React.createElement("div", { id: "full-calc" },
      React.createElement("div", { id: "display" }, this.state.displayValue),
      React.createElement("div", { id: "calc-pad" },
...
class Button extends React.Component {
  ...
  render() {
    return (
      React.createElement("button", { id: this.props.btID, class: this.props.btClass, type: "button" }, this.props.btKeyChar));
